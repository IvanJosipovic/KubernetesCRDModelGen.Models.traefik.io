...
public partial class V1alpha1IngressRouteList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1IngressRoute>
{
    ...
    public string Kind { get; set; } = "IngressRouteList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1IngressRoute objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1IngressRoute> Items { get; set; }
}
...
{
    /// <summary>Name defines the name of the referenced IngressRoute resource.</summary>
    [JsonPropertyName("name")]
    public required string Name { get; set; }

    /// <summary>Namespace defines the namespace of the referenced IngressRoute resource.</summary>
...
{
    [EnumMember(Value = "minimal"), JsonStringEnumMemberName("minimal")]
    Minimal,
    [EnumMember(Value = "detailed"), JsonStringEnumMemberName("detailed")]
    Detailed
}
...
public partial class V1alpha1IngressRouteSpecRoutesObservability
{
    ...
    public V1alpha1IngressRouteSpecRoutesObservabilityTraceVerbosityEnum? TraceVerbosity { get; set; }
...
public partial class V1alpha1IngressRouteSpecRoutesServicesStickyCookie
{
    ...
    public V1alpha1IngressRouteSpecRoutesServicesStickyCookieSameSiteEnum? SameSite { get; set; }
...
public partial class V1alpha1IngressRouteSpecRoutesServices
{
    ...
    public IList<V1alpha1IngressRouteSpecRoutesServicesMiddlewares>? Middlewares { get; set; }
    ...
    public V1alpha1IngressRouteSpecRoutesServicesPassiveHealthCheck? PassiveHealthCheck { get; set; }
    ...
    public V1alpha1IngressRouteSpecRoutesServicesStrategyEnum? Strategy { get; set; }
...
public partial class V1alpha1IngressRouteSpec
{
    ...
    public IList<V1alpha1IngressRouteSpecParentRefs>? ParentRefs { get; set; }

    /// <summary>Routes defines the list of routes.</summary>
    [JsonPropertyName("routes")]
    public required IList<V1alpha1IngressRouteSpecRoutes> Routes { get; set; }
...
public partial class V1alpha1IngressRoute : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1IngressRouteSpec>
{
    ...
    public required V1alpha1IngressRouteSpec Spec { get; set; }
}