...
public partial class V1TLSRouteList : IKubernetesObject<V1ListMeta>, IItems<V1TLSRoute>
{
    ...
    public const string KubeKind = "TLSRouteList";
    ...
    public string Kind { get; set; } = "TLSRouteList";
...
public partial class V1TLSRouteSpecRules
{
    ...
    public required IList<V1TLSRouteSpecRulesBackendRefs> BackendRefs { get; set; }

    /// <summary>Name is the name of the route rule. This name MUST be unique within a Route if it is set.</summary>
    [JsonPropertyName("name")]
...
public partial class V1TLSRouteSpec
{
    ...
    public IList<V1TLSRouteSpecParentRefs>? ParentRefs { get; set; }

    /// <summary>Rules are a list of actions.</summary>
    [JsonPropertyName("rules")]
    public required IList<V1TLSRouteSpecRules> Rules { get; set; }
}
...
public partial class V1TLSRouteStatusParentsConditions
{
    ...
    public required V1TLSRouteStatusParentsConditionsStatusEnum Status { get; set; }
...
public partial class V1TLSRouteStatusParents
{
    ...
    public required IList<V1TLSRouteStatusParentsConditions> Conditions { get; set; }
    ...
    public required V1TLSRouteStatusParentsParentRef ParentRef { get; set; }
}
...
public partial class V1TLSRouteStatus
{
    ...
    public required IList<V1TLSRouteStatusParents> Parents { get; set; }
}
...
public partial class V1TLSRoute : IKubernetesObject<V1ObjectMeta>, ISpec<V1TLSRouteSpec>, IStatus<V1TLSRouteStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TLSRoute";
    ...
    public required V1TLSRouteSpec Spec { get; set; }

    /// <summary>Status defines the current state of TLSRoute.</summary>
    [JsonPropertyName("status")]
    public V1TLSRouteStatus? Status { get; set; }
}